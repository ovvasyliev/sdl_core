...
stages {
	...
	parallel(BldRCON: 
		...
		post {
				...
				failure {
					emailext attachLog: true, body: '${SCRIPT, template="groovy-html.template"}', recipientProviders: [[$class: 'DevelopersRecipientProvider']], replyTo: 'mailer@lc-jenkinsdockerhost.luxoft.com', subject: '${env.JOB_NAME} - Build #${env.BUILD_NUMBER} - ${currentBuild.result}!', to: 'AKutsan@luxoft.com, MGhiumiusliu@luxoft.com, IIKovalenko@luxoft.com, OVVasyliev@luxoft.com'
				}
			}
}